...
export function ChangeIndicatorCard({ indicators }: Props) {
  return (
    <section className="bg-neutral-50 rounded-md shadow-sm p-4 flex flex-col w-full h-full min-h-[260px]">
      <h2 className="text-base md:text-lg text-center md:text-left font-bold text-indigo-600 mb-4">
        리소스 변화 추이
      </h2>

      <div className="flex flex-col  compact:flex-row lg:flex-col flex-wrap justify-center gap-6 md:gap-4 items-stretch">
        {indicators.map((indicator) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`flex items-center gap-1 font-bold whitespace-nowrap text-lg lg:text-base lg:mt-1 ${color}`}
              >
